...
const encryption = handleActions(
    {
        ...
        [actions.getTlsStatusSuccess]: (state: any, { payload }: any) => {
            const newState = {
                ...state,
                ...payload,
        ...
        [actions.setTlsConfigSuccess]: (state: any, { payload }: any) => {
            const newState = {
                ...state,
                ...payload,
                server_name: payload.server_name || '',
        ...
        [actions.validateTlsConfigSuccess]: (state: any, { payload }: any) => {
            const {
                issuer = '',
                key_type = '',
                not_after = '',
